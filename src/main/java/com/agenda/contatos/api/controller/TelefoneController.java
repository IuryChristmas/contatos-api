...
import com.agenda.contatos.api.business.TelefoneBusiness;
...
public class TelefoneController {
	...
	public List<Telefone> buscarPorPessoa(@PathVariable Long idPessoa) {
		return business.buscarTelefonesPorPessoa(idPessoa);
	}
	
	@PostMapping
	public ResponseEntity<Telefone> salvar(@RequestBody Telefone telefone) {
		
		return ResponseEntity.ok(business.salvar(telefone));
	}
